# self-checking aggregation-error vs. robust-estimation bound plot
import torch
import numpy as np
import matplotlib
matplotlib.use("Agg")
...
from attacks import alie_attack
...
if __name__ == "__main__":
    ...
    plt.savefig("theory_bound.png", dpi=150)
    print("Saved theory_bound.png")